...
$sql = "SELECT BusNumber, Type, PerDayPrice, Image FROM Bus WHERE RentalID = '$RentalID'";
...
<div class="container mt-5">
    ...
    <form action="AddBus.php" method="POST" enctype="multipart/form-data" class="mb-5 p-4 bg-white shadow rounded">
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" name="txtBusNum" id="txtBusNum" class="form-control" required>
            </div>
            <div class="col-md-4 mb-3">
                <label>Type</label>
        ...
        <tbody>
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td><img src='uploads/" . htmlspecialchars($row['Image']) . "' alt='Vehicle Image' width='100'></td>";
                    echo "</tr>";
                }
            } else {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        for (let i = 1; i < rows.length; i++) {
            rows[i].addEventListener("click", function () {
                ...
                if (cells.length >= 4) {
                    document.getElementById("txtBusNum").value = cells[0].innerText;
