...
if (isset($_POST["btnAdd"])) {
    ...
    $sql = "INSERT INTO Bus (BusNumber, Type, PerDayPrice, RentalID, Image) 
            VALUES ('$BusNum', '$Type', '$Price', '$RentalID', '$imageFileName')";

    if (mysqli_query($con, $sql)) {
        echo "<script>alert('Vehicle added successfully!'); window.location.href='ManageBus.php';</script>";
    } else {
...
if (isset($_POST["btnUpdate"])) {
    ...
    $sql = "UPDATE Bus 
            ...
            WHERE BusNumber = '$BusNum' AND RentalID = '$RentalID'";

    if (mysqli_query($con, $sql)) {
        echo "<script>alert('Vehicle updated successfully!'); window.location.href='ManageBus.php';</script>";
    } else {
        echo "Error: " . mysqli_error($con);
    }
}
...
if (isset($_POST["btnRemove"])) {
    ...
    if (mysqli_query($con, $sql)) {
        echo "<script>alert('Vehicle deleted successfully!'); window.location.href='ManageBus.php';</script>";
    } else {
        echo "Error: " . mysqli_error($con);
    }
}
